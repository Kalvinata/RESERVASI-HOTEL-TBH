    ...
    <div class="w-full max-w-xl bg-white rounded-2xl shadow-xl p-8 md:p-12">
        ...
        <form action="#" method="POST" class="space-y-4">
            <div>
                ...
                <input type="text" name="name" class="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:ring-2 focus:ring-slate-800 focus:outline-none" placeholder="Masukkan nama sesuai KTP" required>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-slate-600 mb-1">Email</label>
                    <input type="email" name="email" class="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:ring-2 focus:ring-slate-800 focus:outline-none" placeholder="tamu@email.com" required>
                </div>
                <div>
                    <label class="block text-sm font-medium text-slate-600 mb-1">Nomor WhatsApp</label>
                    <input type="tel" name="phone" class="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:ring-2 focus:ring-slate-800 focus:outline-none" placeholder="08123456789" required>
                </div>
            </div>
            ...
            <button type="submit" class="w-full bg-slate-800 text-white font-medium py-3 rounded-lg hover:bg-slate-900 transition-colors mt-4">
                Daftar Sekarang
            </button>
        </form>
